...
pub struct Model {
    ...
    #[sea_orm(
        ...
        on_update = "NoAction",
        on_delete = "NoAction",
        unique_key = "work_alias_idx_primary"
    )]
    pub work: i32,
    pub name: String,
    #[sea_orm(column_type = "Text", nullable, unique_key = "work_alias_idx_primary")]
    ...
    pub work_alias_type: HasOne<super::work_alias_type::Entity>,
}
