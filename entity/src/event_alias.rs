...
pub struct Model {
    ...
    #[sea_orm(
        ...
        on_update = "NoAction",
        on_delete = "NoAction",
        unique_key = "event_alias_idx_primary"
    )]
    pub event: i32,
    pub name: String,
    #[sea_orm(column_type = "Text", nullable, unique_key = "event_alias_idx_primary")]
    ...
    pub event_alias_type: HasOne<super::event_alias_type::Entity>,
}
