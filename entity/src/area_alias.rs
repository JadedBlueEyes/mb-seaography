...
pub struct Model {
    ...
    #[sea_orm(
        ...
        on_update = "NoAction",
        on_delete = "NoAction",
        unique_key = "area_alias_idx_primary"
    )]
    pub area: i32,
    pub name: String,
    #[sea_orm(column_type = "Text", nullable, unique_key = "area_alias_idx_primary")]
    ...
    pub area_alias_type: HasOne<super::area_alias_type::Entity>,
}
