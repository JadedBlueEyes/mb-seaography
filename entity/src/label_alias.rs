...
pub struct Model {
    ...
    #[sea_orm(
        ...
        on_update = "NoAction",
        on_delete = "NoAction",
        unique_key = "label_alias_idx_primary"
    )]
    pub label: i32,
    pub name: String,
    #[sea_orm(column_type = "Text", nullable, unique_key = "label_alias_idx_primary")]
    ...
    pub label_alias_type: HasOne<super::label_alias_type::Entity>,
}
