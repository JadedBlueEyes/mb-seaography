...
#[sea_orm(schema_name = "musicbrainz", table_name = "l_work_work")]
pub struct Model {
    #[sea_orm(primary_key)]
    pub id: i32,
    #[sea_orm(
        ...
        on_update = "NoAction",
        on_delete = "NoAction",
        unique_key = "l_work_work_idx_uniq"
    )]
    pub link: i32,
    #[sea_orm(unique_key = "l_work_work_idx_uniq")]
    pub entity0: i32,
    #[sea_orm(unique_key = "l_work_work_idx_uniq")]
    pub entity1: i32,
    ...
    pub work_2: HasOne<super::work::Entity>,
    #[sea_orm(
        belongs_to,
        relation_enum = "Work1",
        from = "entity1",
    ...
    pub work_1: HasOne<super::work::Entity>,
}
