...
#[sea_orm(schema_name = "musicbrainz", table_name = "l_instrument_release")]
pub struct Model {
    #[sea_orm(primary_key)]
    pub id: i32,
    #[sea_orm(
        ...
        on_update = "NoAction",
        on_delete = "NoAction",
        unique_key = "l_instrument_release_idx_uniq"
    )]
    pub link: i32,
    #[sea_orm(unique_key = "l_instrument_release_idx_uniq")]
    pub entity0: i32,
    #[sea_orm(unique_key = "l_instrument_release_idx_uniq")]
    pub entity1: i32,
